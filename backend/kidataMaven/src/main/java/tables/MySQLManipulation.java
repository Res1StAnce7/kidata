...
public class MySQLManipulation {
    ...
    public void insert(String name, String[] cols, String[] vals, String tcl)
        throws SQLException {
    ...
    public void delete(String name, String col, String[] vals, String tcl)
        throws SQLException {
    ...
    public void select(String name, String[] cols, String[] vals, String tcl)
        throws SQLException {
